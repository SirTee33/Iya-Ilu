    ...
    <div className="about-page">
      ...
      <div className="about-banner">
        <div className="banner-overlay">
          <h1>The Talking Drum</h1>
          <h2>Mother of All Drums</h2>
        </div>
      </div>
      ...
      {/* Gallery Section *}
      <div className="gallery-section">
        <h2>Types of Talking Drums</h2>
        <div className="gallery-grid">
          <img src={iya1} alt="Talking Drum Type 1" />
          <img src={iya2} alt="Talking Drum Type 2" />
          <img src={iya3} alt="Talking Drum Type 3" />
          <img src={iya4} alt="Talking Drum Type 4" />
        </div>
      </div>
    </div>
  );
